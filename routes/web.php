...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/admin/profile/change-password', [ProfileController::class, 'showChangePasswordForm'])->name('admin.profile.change-password-form');
...
Route::middleware(['auth:employee'])->group(function () {
    ...
    Route::post('/employee/profile', [ProfileController::class, 'update'])->name('employee.profile.update');
    Route::get('/employee/profile/change-password', [ProfileController::class, 'showChangePasswordForm'])->name('employee.profile.change-password-form');
    Route::post('/employee/profile/change-password', [ProfileController::class, 'changePassword'])->name('employee.profile.change-password');
});
