...
@section('title', 'Create IBPLS Record')
...
<div class="container-fluid">
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="{{ route('ibpls.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('operation') is-invalid @enderror" 
                        ...
                        <option value="Operational" {{ old('operation') == 'Operational' ? 'selected' : '' }}>Operational</option>
                        <option value="ETRACS/Others" {{ old('operation') == 'ETRACS/Others' ? 'selected' : '' }}>ETRACS/Others</option>
                        <option value="Ongoing eLGU V2" {{ old('operation') == 'Ongoing eLGU V2' ? 'selected' : '' }}>Ongoing eLGU V2</option>
                    </select>
                    @error('operation')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('status') is-invalid @enderror" 
                        ...
                        <option value="Integrated" {{ old('status') == 'Integrated' ? 'selected' : '' }}>Integrated</option>
