...
<div class="modal fade" id="addOrientationModal" tabindex="-1" aria-labelledby="addOrientationModalLabel"
    aria-hidden="true">
            ...
            <form action="{{ route('egov-orientation.store') }}" method="POST" id="addOrientationForm">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text"
                                class="form-control @error('training_control_no') is-invalid @enderror"
                                id="training_control_no" name="training_control_no"
                                value="{{ old('training_control_no') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('event_type') is-invalid @enderror"
                                ...
                                placeholder="e.g., Training, Workshop, Seminar">
                            @error('event_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="participants" class="form-label">Participants <span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="municipality" class="form-label">Municipality <span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('mode') is-invalid @enderror" id="mode"
                                ...
                                <option value="Face to Face" {{ old('mode') == 'Face to Face' ? 'selected' : '' }}>
                                    Face to Face</option>
                            </select>
                            @error('mode')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="no_of_attendees" class="form-label">No. of Attendees <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('no_of_attendees') is-invalid @enderror"
                                id="no_of_attendees" name="no_of_attendees" value="{{ old('no_of_attendees') }}"
                                required>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="no_of_downloaded_and_verified" class="form-label">No. of Downloaded &
                                Verified</label>
                            <input type="text"
                                class="form-control @error('no_of_downloaded_and_verified') is-invalid @enderror"
                                id="no_of_downloaded_and_verified" name="no_of_downloaded_and_verified"
                                value="{{ old('no_of_downloaded_and_verified') }}">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('male') is-invalid @enderror"
                                id="male" name="male" value="{{ old('male') }}">
                            @error('male')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('female') is-invalid @enderror"
                                id="female" name="female" value="{{ old('female') }}">
                            @error('female')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn" style="background-color: #003566; color: white;">
                        <i class="fas fa-save mx-1"></i> Save Orientation
                    </button>
                </div>
            </form>
        </div>
