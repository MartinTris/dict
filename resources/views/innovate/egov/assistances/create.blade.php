            ...
            <form action="{{ route('egov-assistance.store') }}" method="POST" id="addAssistanceForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('concern') is-invalid @enderror" id="concern" name="concern" rows="4">{{ old('concern') }}</textarea>
                            @error('concern')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn" style="background-color: #003566; color: white;">
                            <i class="fas fa-save mx-1"></i> Save Assistance
                        </button>
