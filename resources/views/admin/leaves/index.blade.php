        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fa-solid fa-clipboard-list mr-2"></i>Leave Management
                </h6>
            </div>
            <div class="card-body">
                <form method="GET" class="mb-4">
                    <div class="form-row align-items-end">
                        ...
                        <div class="form-group col-md-3">
                            <label class="font-weight-bold text-gray-700">Employee</label>
                        ...
                        <div class="form-group col-md-3">
                            <label class="font-weight-bold text-gray-700">Search</label>
                            <input name="search" class="form-control" placeholder="Search name/reason">
                        </div>
