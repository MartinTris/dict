                ...
                <form action="{{ route('pnpki.update', $pnpki->id) }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('date_conducted') is-invalid @enderror" 
                                    id="date_conducted" name="date_conducted" value="{{ old('date_conducted', $pnpki->date_conducted) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('time_conducted') is-invalid @enderror" 
                                    id="time_conducted" name="time_conducted" value="{{ old('time_conducted', $pnpki->time_conducted) }}" 
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('organizer') is-invalid @enderror" 
                                    id="organizer" name="organizer" value="{{ old('organizer', $pnpki->organizer) }}" required>
                                @error('organizer')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('activity_title') is-invalid @enderror" 
                            id="activity_title" name="activity_title" value="{{ old('activity_title', $pnpki->activity_title) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('type_of_activity') is-invalid @enderror" 
                                    ...
                                    <option value="PNPKI Orientation" {{ old('type_of_activity', $pnpki->type_of_activity) == 'PNPKI Orientation' ? 'selected' : '' }}>PNPKI Orientation</option>
                                    <option value="PNPKI Personnel Training" {{ old('type_of_activity', $pnpki->type_of_activity) == 'PNPKI Personnel Training' ? 'selected' : '' }}>PNPKI Personnel Training</option>
                                    <option value="PNPKI User's Training" {{ old('type_of_activity', $pnpki->type_of_activity) == "PNPKI User's Training" ? 'selected' : '' }}>PNPKI User's Training</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('mode_of_implementation') is-invalid @enderror" 
                                    id="mode_of_implementation" name="mode_of_implementation" value="{{ old('mode_of_implementation', $pnpki->mode_of_implementation) }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('male_participants') is-invalid @enderror" 
                                    id="male_participants" name="male_participants" value="{{ old('male_participants', $pnpki->male_participants) }}" 
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('female_participants') is-invalid @enderror" 
                                    id="female_participants" name="female_participants" value="{{ old('female_participants', $pnpki->female_participants) }}" 
                                    min="0" required onchange="calculateTotal()">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="total_participants" value="{{ $pnpki->total_participants }}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('participant_details') is-invalid @enderror" 
                            id="participant_details" name="participant_details" rows="3" required>{{ old('participant_details', $pnpki->participant_details) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('resource_person') is-invalid @enderror" 
                            id="resource_person" name="resource_person" value="{{ old('resource_person', $pnpki->resource_person) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('fb_posting') is-invalid @enderror" 
                                    id="fb_posting" name="fb_posting" value="{{ old('fb_posting', $pnpki->fb_posting) }}">
                                @error('fb_posting')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('number_of_engagement') is-invalid @enderror" 
                                    id="number_of_engagement" name="number_of_engagement" value="{{ old('number_of_engagement', $pnpki->number_of_engagement) }}" min="0">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('list_of_engaged_partners') is-invalid @enderror" 
                            id="list_of_engaged_partners" name="list_of_engaged_partners" rows="3" required>{{ old('list_of_engaged_partners', $pnpki->list_of_engaged_partners) }}</textarea>
