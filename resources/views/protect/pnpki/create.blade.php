                ...
                <form action="{{ route('pnpki.store') }}" method="POST">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('district') is-invalid @enderror" id="district"
                                    ...
                                    <option value="1ST" {{ old('district') == '1ST' ? 'selected' : '' }}>1ST DISTRICT
                                    </option>
                                    <option value="2ND" {{ old('district') == '2ND' ? 'selected' : '' }}>2ND DISTRICT
                                    </option>
                                    <option value="3RD" {{ old('district') == '3RD' ? 'selected' : '' }}>3RD DISTRICT
                                    </option>
                                    <option value="4TH" {{ old('district') == '4TH' ? 'selected' : '' }}>4TH DISTRICT
                                    </option>
                                    <option value="5TH" {{ old('district') == '5TH' ? 'selected' : '' }}>5TH DISTRICT
                                    </option>
                                    <option value="6TH" {{ old('district') == '6TH' ? 'selected' : '' }}>6TH DISTRICT
                                    </option>
                                    <option value="7TH" {{ old('district') == '7TH' ? 'selected' : '' }}>7TH DISTRICT
                                    </option>
                                    <option value="8TH" {{ old('district') == '8TH' ? 'selected' : '' }}>8TH DISTRICT
                                    </option>
                                </select>
                                @error('district')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('type_of_activity') is-invalid @enderror"
                                    ...
                                    <option value="PNPKI Orientation"
                                        {{ old('type_of_activity') == 'PNPKI Orientation' ? 'selected' : '' }}>PNPKI
                                        Orientation</option>
                                    <option value="PNPKI Personnel Training"
                                        {{ old('type_of_activity') == 'PNPKI Personnel Training' ? 'selected' : '' }}>PNPKI
                                        Personnel Training</option>
                                    <option value="PNPKI User's Training"
                                        {{ old('type_of_activity') == "PNPKI User's Training" ? 'selected' : '' }}>PNPKI
                                        User's Training</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('mode_of_implementation') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('male_participants', 0) }}" min="0" required
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('female_participants', 0) }}" min="0" required
                                    onchange="calculateTotal()">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="total_participants" value="0"
                                    readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('participant_details') is-invalid @enderror" id="participant_details"
                            name="participant_details" rows="3" required>{{ old('participant_details') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('number_of_engagement') }}" min="0">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('list_of_engaged_partners') is-invalid @enderror" id="list_of_engaged_partners"
                            name="list_of_engaged_partners" rows="3" required>{{ old('list_of_engaged_partners') }}</textarea>
