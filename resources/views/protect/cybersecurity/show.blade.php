    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <p><a href="{{ $cybersecurity->zoom_link }}" target="_blank">{{ $cybersecurity->zoom_link }}</a></p>
            </div>
            @endif
            ...
            <div class="mb-3">
                ...
                <p><a href="{{ $cybersecurity->fb_posting }}" target="_blank">{{ $cybersecurity->fb_posting }}</a></p>
            </div>
            @endif
            ...
            <div class="form-group text-center mt-4">
                <a href="{{ route('cybersecurity.visualization') }}" class="btn btn-info">
                    <i class="fas fa-chart-bar"></i> View Data Visualization
                </a>
                <a href="{{ route('cybersecurity.edit', $cybersecurity->id) }}" class="btn btn-primary" style="background-color: #003566; border-color: #003566;">
                    <i class="fas fa-edit"></i> Edit Record
                </a>
                <form action="{{ route('cybersecurity.destroy', $cybersecurity->id) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
