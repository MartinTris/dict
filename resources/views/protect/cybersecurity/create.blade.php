...
@section('contents')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('cybersecurity.store') }}" method="POST">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('type_of_activity') is-invalid @enderror" 
                                    ...
                                    <option value="Cyber Advocacies" {{ old('type_of_activity') == 'Cyber Advocacies' ? 'selected' : '' }}>Cyber Advocacies</option>
                                    <option value="CERT Trainings" {{ old('type_of_activity') == 'CERT Trainings' ? 'selected' : '' }}>CERT Trainings</option>
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('participant_details') is-invalid @enderror" 
                            id="participant_details" name="participant_details" rows="3">{{ old('participant_details') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('list_of_engaged_partners') is-invalid @enderror" 
                            id="list_of_engaged_partners" name="list_of_engaged_partners" rows="3">{{ old('list_of_engaged_partners') }}</textarea>
