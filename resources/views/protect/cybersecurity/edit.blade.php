...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3" style="background-color: #003566;">
            <h6 class="m-0 font-weight-bold text-white">Edit Activity Details</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('cybersecurity.update', $cybersecurity->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('date_conducted') is-invalid @enderror" 
                                id="date_conducted" name="date_conducted" value="{{ old('date_conducted', $cybersecurity->date_conducted) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('time_conducted') is-invalid @enderror" 
                                id="time_conducted" name="time_conducted" value="{{ old('time_conducted', $cybersecurity->time_conducted) }}" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('organizer') is-invalid @enderror" 
                                id="organizer" name="organizer" value="{{ old('organizer', $cybersecurity->organizer) }}" required>
                            @error('organizer')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('activity_title') is-invalid @enderror" 
                        id="activity_title" name="activity_title" value="{{ old('activity_title', $cybersecurity->activity_title) }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('type_of_activity') is-invalid @enderror" 
                                ...
                                <option value="Cyber Advocacies" {{ old('type_of_activity', $cybersecurity->type_of_activity) == 'Cyber Advocacies' ? 'selected' : '' }}>Cyber Advocacies</option>
                                <option value="CERT Trainings" {{ old('type_of_activity', $cybersecurity->type_of_activity) == 'CERT Trainings' ? 'selected' : '' }}>CERT Trainings</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('mode_of_implementation') is-invalid @enderror" 
                                id="mode_of_implementation" name="mode_of_implementation" value="{{ old('mode_of_implementation', $cybersecurity->mode_of_implementation) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('zoom_link') is-invalid @enderror" 
                        id="zoom_link" name="zoom_link" value="{{ old('zoom_link', $cybersecurity->zoom_link) }}">
                    @error('zoom_link')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('male_participants') is-invalid @enderror" 
                                id="male_participants" name="male_participants" value="{{ old('male_participants', $cybersecurity->male_participants) }}" 
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('female_participants') is-invalid @enderror" 
                                id="female_participants" name="female_participants" value="{{ old('female_participants', $cybersecurity->female_participants) }}" 
                                min="0" required onchange="updateTotal()">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="total_participants" 
                                value="{{ $cybersecurity->male_participants + $cybersecurity->female_participants }}" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('participant_details') is-invalid @enderror" 
                        id="participant_details" name="participant_details" rows="3">{{ old('participant_details', $cybersecurity->participant_details) }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('resource_person') is-invalid @enderror" 
                        id="resource_person" name="resource_person" value="{{ old('resource_person', $cybersecurity->resource_person) }}" required>
                ...
                <div class="form-group">
                    <label for="fb_posting">FB Posting</label>
                    <input type="text" class="form-control @error('fb_posting') is-invalid @enderror" 
                        id="fb_posting" name="fb_posting" value="{{ old('fb_posting', $cybersecurity->fb_posting) }}">
                    @error('fb_posting')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="number_of_engagement">Number of Engagement</label>
                    <input type="number" class="form-control @error('number_of_engagement') is-invalid @enderror" 
                        id="number_of_engagement" name="number_of_engagement" value="{{ old('number_of_engagement', $cybersecurity->number_of_engagement) }}" min="0">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('list_of_engaged_partners') is-invalid @enderror" 
                        id="list_of_engaged_partners" name="list_of_engaged_partners" rows="3">{{ old('list_of_engaged_partners', $cybersecurity->list_of_engaged_partners) }}</textarea>
