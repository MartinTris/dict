...
<head>
    ...
    <title>DICT Cavite Monitoring - Employee Register</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="{{ route('employee.register.save') }}" method="POST" class="user"
                                id="registrationForm">
                                @csrf
                                ...
                                <div class="password-requirements">
                                    ...
                                    <div class="requirements-grid">
                                        ...
                                        <div class="requirement-item requirement-not-met" id="special"
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="{{ route('employee.login') }}">Already have an account?
                                    Login!</a>
                            </div>
                        </div>
                    </div>
